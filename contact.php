...
<section class="contact-section">
    <div class="container">
        ...
        <div class="row g-4 align-items-start">
            <!-- Contact Form -->
            <div class="col-lg-8">
                <form class="form-contact contact_form shadow p-4 rounded bg-light mb-4" action="contact_process.php"
                    ...
                    <div class="mt-3">
                        <textarea class="form-control rounded-3 ps-4" name="message" id="message" rows="6"
                            placeholder="✍️ Type your message here..." required></textarea>
                    </div>
            ...
            <div class="col-lg-4">
                <div class="d-flex flex-column gap-3">
                    ...
                    <div class="card shadow-sm border-0 rounded-3 p-3 text-center hover-shadow">
                        ...
                        <small class="text-muted">Call or WhatsApp (24/7)</small>
                    </div>
